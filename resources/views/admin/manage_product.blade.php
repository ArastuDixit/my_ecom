...
<script>
   ...
   function add_more(){
       ...
       var html='<div class="card" id="product_attr_'+loop_count+'"><div class="card-body"><div class="form-group"><div class="row">';
        ...
        html+='<div class="col-md-2"><label for="size_id" class="control-label mb-1">Size</label><select id="size_id" name="size_id" class="form-control" required="">'+size_id_html+'</select></div>';

        var color_id_html=jQuery('#color_id').html();
        html+='<div class="col-md-2"><label for="color_id" class="control-label mb-1">Color</label><select id="color_id" name="color_id" class="form-control" required="">'+color_id_html+'</select></div>';
